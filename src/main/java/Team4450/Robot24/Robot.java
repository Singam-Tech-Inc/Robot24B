 ...
 * between out team code and the FIRST supplied (WpiLib) robot control infrastructure. The WpiLib
 * host automatically loads this class, and calls the functions corresponding to each mode, as
...
public class Robot extends TimedRobot {
  ...
  public void robotInit() {
    try {
      ...
      // or SB in order to be sent so its a catch-22 with static Sendables. So we add the
      // SendableVersion
  ...
  /**
   * This function is called periodically during disabled mode. Technically there should be nothing
   * here.
   */
  @Override
  ...
  /**
   * This function is called once at the start of autonomous mode and schedules the autonomous
  ...
  /**
   * This function is called periodically during autonomous. Technically there should be nothing
   * here.
   */
  @Override
  ...
  /**
   * This function is called periodically during teleop. Technically there should be nothing here.
   */
  @Override
