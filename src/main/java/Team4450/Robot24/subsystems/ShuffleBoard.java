...
/**
 * This class hosts functions relating to communicating with the ShuffleBoard driver station
 * application. Primarily, it's periodic function handles the regular update of the "LCD" panel's
 * display of robot status information when the robot is active.
 */
public class ShuffleBoard extends SubsystemBase {
    ...
    public void updateDS() {
        ...
        LCD.printLine(LCD_4, "pose x=%.1fm  y=%.1fm  deg=%.1f  yaw=%.1f", pose.getX(), pose.getY(),
                pose.getRotation().getDegrees(), RobotContainer.driveBase.getYaw());
    ...
    /**
     * Switch tab on shuffleboard display by tab name. Will create the tab if it does not already
     * exist.
     * 
