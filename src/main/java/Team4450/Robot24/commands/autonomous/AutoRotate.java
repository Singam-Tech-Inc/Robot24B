...
/**
 * A command that will turn the robot to the specified angle using a PID command. Acceleration is a
...
public class AutoRotate extends PIDCommand {
    ...
    public void end(boolean interrupted) {
        ...
        Util.consoleLog("hdg=%.2f  target=%.2f  yaw=%.2f  error=%.2f pct",
                RobotContainer.navx.getHeading(), getController().getSetpoint(), driveBase.getYaw(),
