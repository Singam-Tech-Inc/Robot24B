...
/**
 * This is an example autonomous command using 4450 written library of auto driving support
 * commands.
 */
public class TestAuto1 extends Command {
	...
	/**
	 * Creates a new TestAuto1 autonomous command. This command demonstrates one possible structure
	...
	public void initialize() {
		...
		LCD.printLine(LCD_1, "Mode: Auto - TestAuto1 - All=%s, Location=%d, FMS=%b, msg=%s",
